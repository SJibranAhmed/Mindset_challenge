...
st.write("Convert CSV files into Excel format")

# File uploader
uploaded_files = st.file_uploader("Upload your (CSV or XLSX) files:", type=["csv", "xlsx"], accept_multiple_files=True)
...
if uploaded_files:
    for file in uploaded_files:
        ...
        file_size = file.getbuffer().nbytes / 1024  # Convert to KB
